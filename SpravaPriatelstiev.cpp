...
//true ak doslo k problemu
bool SpravaPriatelstiev::posliZiadostOPriatelstvo(Pouzivatel* pouzivatel, Data* data, SocketAMutex* socketAMutex) {
...
bool SpravaPriatelstiev::odoberZPriatelov(Pouzivatel* pouzivatel, Data* data, SocketAMutex* socketAMutex) {
    bool koniec = false;
    while(!koniec) {
...
bool SpravaPriatelstiev::potvrdenieAleboZamietnutieZiadosti(Pouzivatel* pouzivatel, Data* data, SocketAMutex* socketAMutex) {
    bool koniec = false;
    while(!koniec) {
