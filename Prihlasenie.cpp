...
Pouzivatel* Prihlasenie::prihlasenie(Data* data, SocketAMutex* socketAMutex) {
...
Pouzivatel* Prihlasenie::prihlasSa(Data* data, SocketAMutex* socketAMutex) {
...
bool Prihlasenie::registrujSa(Data* data, SocketAMutex* socketAMutex) {
